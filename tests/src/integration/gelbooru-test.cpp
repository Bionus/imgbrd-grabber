...
{
	QList<Image*> images = getImages("Gelbooru (0.2)", "gelbooru.com", "regex", "rating:safe", "results.html");
...
{
	QList<Image*> images = getImages("Gelbooru (0.2)", "gelbooru.com", "xml", "rating:safe", "results.xml");
