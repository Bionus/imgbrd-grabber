...
bool Filename::isValid(Profile *profile, QString *error) const
{
	...
	QStringList knownTokens {"tags", "artist", "general", "copyright", "character", "model", "photo_set", "species", "meta", "filename", "rating", "md5", "website", "websitename", "ext", "all", "id", "search", "search_(\\d+)", "allo", "date", "aspect_ratio", "score", "count", "width", "height", "pool", "url_file", "url_page", "num", "name", "position", "current_date", "author" };
	if (profile != nullptr) {
